...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const allMenuItems = [
    ...
    { name: 'Fournisseurs', path: '/fournisseurs', icon: Truck, roles: ['Administrateur', 'Magasinier'] },
    ...
    { name: 'Achats fournisseurs', path: '/achats', icon: ShoppingCart, roles: ['Administrateur', 'Directeur', 'Magasinier'] },
    { name: 'Ventes clients', path: '/ventes', icon: ShoppingBag, roles: ['Administrateur', 'Vendeur'] },
    { name: 'Paiements', path: '/paiements', icon: CreditCard, roles: ['Administrateur', 'Vendeur', 'Magasinier'] },
